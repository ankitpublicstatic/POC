...
import com.ankit.poc.example.DataBase;
...
public class SortListDemo {
  ...
  public static void main(String[] args) {
     ...
     * 
     * @Override public int compare(Employee o1, Employee o2) { return (int) (o1.getSalary() -
     * o2.getSalary());// ascending } });
     */
    ...
    /*
     * Collections.sort(list);//ASSENDING Collections.reverse(list); System.out.println(list);
     * 
