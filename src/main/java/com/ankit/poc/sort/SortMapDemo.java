...
import com.ankit.poc.example.Employee;
...
public class SortMapDemo {
  ...
  public static void main(String[] args) {
    ...
    Map<Employee, Integer> employeeMap =
        new TreeMap<>((o1, o2) -> (int) (o2.getSalary() - o1.getSalary()));
    ...
    Collections.sort(entries, Comparator.comparing(Entry<String, Integer>::getKey));

    /*
     * for (Entry<String, Integer> entry : entries) { System.out.println(entry.getKey() + "   " +
     * entry.getValue()); }
     */
