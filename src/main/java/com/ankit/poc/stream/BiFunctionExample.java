...
public class BiFunctionExample implements BiFunction<List<Integer>, List<Integer>, List<Integer>> {
  ...
  public static void main(String[] args) {
    ...
    BiFunction<List<Integer>, List<Integer>, List<Integer>> biFunction1 =
        (l1, l2) -> Stream.of(l1, l2).flatMap(List::stream).distinct().collect(Collectors.toList());
    ...
    Function<List<Integer>, List<Integer>> sortedFunction =
        (lists) -> lists.stream().sorted().collect(Collectors.toList());

    System.out
        .println("Lambda approach : " + biFunction2.andThen(sortedFunction).apply(list1, list2));
    ...
    BiFunction<String, Integer, Integer> increaseSalaryBiFunction =
