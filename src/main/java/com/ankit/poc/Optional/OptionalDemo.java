package com.ankit.poc.Optional;
...
public class OptionalDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Customer customer =
        new Customer(101, "john", "test@gmail.com", Arrays.asList("397937955", "21654725"));
    ...
    Optional<String> emailOptional2 = null;
    ...
    // System.out.println(emailOptional2.orElseThrow(()->new IllegalArgumentException("email not
    // present")));
